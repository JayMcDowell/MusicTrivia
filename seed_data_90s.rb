...
question_list = [
  ...
  [ '90s', 'Who married movie producer John Leventhal in 1995?', 'Dolly Parton', 'Loretta Lynn', 'Rosanne Cash', 'Tammy Wynette', 'Rosanne Cash' ],
  [ '90s', 'What is singer/songwriter Desmond Childs real name?', 'Eugene Dixon', 'Andrew Wright', 'Howard Bailey', 'John Charles Barrett, Jr.', 'John Charles Barrett, Jr.' ],
  ...
  [ '90s', 'What Australian country singer appeared on "The Facts Of Life"?', 'Reba McEntire', 'Sherie Austin', 'Amanda McCAdams', 'Lynn Anderson', 'Sherie Austin' ],
  ...
  [ '90s', 'Who originally recorded Garth Brooks hit "The Thunder Rolls"?', 'Tanya Tucker', 'Reba McEntire', 'Trisha Yearwood', 'Tammy Wynette', 'Tanya Tucker' ],
